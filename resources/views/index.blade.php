        ...
        <div class="max-w-4xl mx-auto flex flex-col gap-20 relative">
            ...
            <div class="relative">
                <img src="{{ asset('asset/img/ai-img-g-1.png') }}" alt="Robot Reading"
                    class="absolute top-10 sm:-top-10 -left-3 sm:left-4 w-30 sm:w-40 h-auto z-10" />
                <div class="flex justify-end bg-gradient-to-r from-white via-blue-100 to-blue-400 rounded-3xl px-5 sm:px-10 py-12 mt-10"
            ...
            <!-- Card 2 -->
            <div class="relative">
                <img src="{{ asset('asset/img/ai-img-g-2.png') }}" alt="Robot Waving"
                    class="absolute top-8 sm:-top-8 -right-5 sm:right-4 w-35 sm:w-45 h-auto z-10" />
                <div class="flex justify-start bg-gradient-to-l from-white via-blue-100 to-blue-400 rounded-xl px-5 sm:px-10 py-12 mt-10"
                    style="box-shadow:-6px 0px 0px 0px #007eff, 0 4px 24px 0 rgba(0,0,0,0.18);">
                    <a href="{{ route('meet-your-ai-buddy') }}" class="text-white font-semibold text-lg hover:underline">
                        Meet Your AI Buddy
                    </a>
                </div>
            </div>
            ...
            <div class="relative">
                <img src="{{ asset('asset/img/ai-img-g-3.png') }}" alt="Robot Searching"
                    class="absolute top-8 sm:-top-8 -left-5 sm:left-4 w-43 sm:w-55 h-auto z-10" />
                <div class="flex justify-end bg-gradient-to-r from-white via-blue-100 to-blue-400 rounded-xl px-5 sm:px-10 py-12 mt-10"
                    style="box-shadow:6px 0px 0px 0px #007eff, 0 4px 24px 0 rgba(0,0,0,0.18);">
